...
export const sfx = {
  ...
  blockPlace() {
    play(660, 'square', 0.06, 0.05);
  },
  blockRemove() {
    play(440, 'square', 0.06, 0.04);
  },
  buildingGrow() {
    play(392, 'sine', 0.15, 0.08);
    setTimeout(() => play(523, 'sine', 0.15, 0.08), 150);
    setTimeout(() => play(659, 'sine', 0.15, 0.08), 300);
    setTimeout(() => play(784, 'sine', 0.2, 0.1), 450);
  },
  bossAppear() {
    play(200, 'sawtooth', 0.3, 0.06);
    setTimeout(() => play(150, 'sawtooth', 0.4, 0.08), 200);
  },
  bossHit() {
    play(300, 'square', 0.08, 0.06);
    setTimeout(() => play(400, 'square', 0.08, 0.06), 60);
  },
};
